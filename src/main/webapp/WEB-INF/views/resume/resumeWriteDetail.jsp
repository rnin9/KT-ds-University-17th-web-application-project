...
<span style="color: white;">이력서 작성</span>
   ...
   <div class="container">
      ...
      <div id="title_area">
            ...
            <button id="first" class="btn headbutton btn-outline-danger move none" 
      ...
      <div class="main">
         ...
         <div id="certificate_list" class="list_field certificateList" name="certificate_list" value="${certificateList1.certificateSEQ}">
            <button id="cer_add" class="btn btn-outline-danger addbutton" type="button">추가</button>
         ...
         <button id="del_button" class="btn btn-outline-danger ${certificate.certificateSEQ}" name="certificate_remove" onclick="remove_div(`${certificate.certificateSEQ}`)">삭제</button>
      ...
      <div class="main">
         ...
         <div id="foreign_list" class="list_field foreignList" value="${foreignList1.foreignSEQ}">
            <button id="for_add" class="btn btn-outline-danger addbutton" type="button">추가</button>
            <div>
         ...
         <button id="del_button" class="btn btn-outline-danger ${foreign.foreignSEQ}" name="foreign_remove" onclick="remove_div(`${foreign.foreignSEQ}`)">삭제</button>
