...
<body>
   ...
   <div class="container">
         ...
         <div id="title_area">
            ...
            <button id="second" class="btn btn-outline-danger headbutton move none" type="submit"
               onClick="getPost('toPage2')">상세정보</button>
            <button id="third" class="btn btn-outline-danger headbutton move none" type="submit"
               onClick="getPost('toPage3')">경력사항 / 교육수료사항</button>
            <button id="forth" class="btn btn-outline-danger headbutton move none" type="submit"
               onClick="getPost('toPage4')">프로젝트 관련사항</button>
            <button id="last" class="btn btn-outline-danger headbutton move none" type="submit"
         ...
         <div class="buttonGroups">
            <button id="btn"
               class="btn button_bottom btn-outline-danger"
