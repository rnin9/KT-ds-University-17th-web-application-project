...
<script>
   function add_div(e, result) {
      ...
      if (e == 'project_list') { //자격증
    	  document.getElementById('profield').appendChild(line);
...
<body>
   ...
   <div class="container">
      ...
      <div id="title_area">
         ...
         <button id="third" class="btn btn-outline-danger headbutton move none"
      ...
      <div class="main">
         ...
         <c:forEach var="project" items="${projectList}">
            <div id="${project.projectSEQ}" name="project_list"
               ...
               <button id="pro_add" class="btn btn-outline-danger addbutton " type="button">추가</button>
               <button id="del_button" class="btn btn-outline-danger ${project.projectSEQ} foreach"
