			...
			<table class="table_" style="margin-top: 100px;">
				<tr>
					...
					<td><input type="text" class="form-control" placeholder="검색"
						id="hiddenThanksTogangsanim" onclick="showPopup();"
						value="${courseVO.syllabusVO.syllabusName}"> <input
						type="text" class="form-control" id="syllabusID" name="syllabusID"
						style="display: none;" value="${courseVO.syllabusID}"></td>
					<th></th>
					<th></th>
				</tr>
				<tr>
					...
					<td><div class="selectBox" style="text-align: left;">
							<select class="form-select" aria-label="Default select example"
								...
								<option value="09:00~18:00"
									<c:if test="${courseVO.courseTime eq '09:00~18:00'}">selected</c:if>>09:00~18:00</option>
								<option value="19:00~22:00"
									<c:if test="${courseVO.courseTime eq '19:00~22:00'}">selected</c:if>>19:00~22:00</option>
						</div></td>
					<th>교육비</th>
					<td><input type="text" class="form-control" placeholder="무료"
						name="courseFee" value="${courseVO.courseFee}"></td>
				</tr>
				<tr>
					<th>수강신청일</th>
					<td id="sandbox-container"><input type="text"
						class="form-control" placeholder="연/월을 선택해주세요."
						name="courseApplyStart" value="${courseVO.courseApplyStart}">
						<input type="text" class="form-control" placeholder="연/월을 선택해주세요."
						name="courseApplyEnd" value="${courseVO.courseApplyEnd}"></td>

					<th>교육기간</th>
					<td id="sandbox-container"><input type="text"
						class="form-control" placeholder="연/월을 선택해주세요." name="courseStart"
						value="${courseVO.courseStart}"> <input type="text"
						class="form-control" placeholder="연/월을 선택해주세요." name="courseEnd"
						value="${courseVO.courseEnd}"></td>
				</tr>
				<tr>
					<th>강의실정보</th>
					<td><input type="text" class="form-control"
						onkeydown="return onlyNumber(event)" onkeyup="removeChar(event)"
						placeholder="강의실(숫자)을 입력하세요." name="courseRoomNumber"
						value="${courseVO.courseRoomNumber}"></td>
					<th>수강인원수</th>
					<td><input type="text" class="form-control"
						onkeydown="return onlyNumber(event)" onkeyup="removeChar(event)"
						placeholder="수강인원수(숫자)를 입력하세요." name="coursePeopleMax"
						value="${courseVO.coursePeopleMax}"></td>
				</tr>
			</table>
