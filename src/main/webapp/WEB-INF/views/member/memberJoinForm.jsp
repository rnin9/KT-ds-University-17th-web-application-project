...
<body>
	...
	<form action="${contextPath}/member/join_member.do" id="joinForm" accept-charset="UTF-8"  name="basic" method="POST">
		<div id="main">
			<div id="title_area">
			...
			alt="로고" /></a>
				<div>
					<label class="title">아이디</label> <input
						type="text" name="id" id="id">
					<div class="eng_name regex" id="id_check"></div>
				</div>
				<div>
					<label class="title">비밀번호</label> <input
						type="password" class="pw" id="pw" name="pwd" placeholder="8자 이상, 공백 불허">
				</div>
				<div>
					<label class="title">비밀번호 확인</label><!-- <span class="must">필수</span> -->
					<input type="password" class="pw" id="pw2" name="pwd2" placeholder="비밀번호 확인">
				</div>
				
				<div>
					<label class="title">성명</label> <input
						type="text" name="name" id="name" placeholder="한글명"
						onfocus="this.placeholder=''" onblur="this.placeholder='한글명'">
					<div class="name regex"></div>
				</div>
				<div>
					<label class="title">이메일</label> <input
						type="text" name="email" id="email">
					<div class="email regex" id="email_check"></div>
				</div>
				<div id="date">
					<label class="title">생년월일</label> <input
						type="text" name="birth" id="datepicker" placeholder="생년월일">
					<!-- <div class="toggle">
				...
				<div>
					<label class="title">휴대폰</label> <input
						type="text" name="phone" id="phone" placeholder="휴대폰 번호 입력"
				...
				<div>
					<label class="title">주소</label> <input
						type="text" name="address" id="roadAddress" placeholder="도로명 주소">
					<input type="button" onclick="sample4_execDaumPostcode()" class="address_detail"
						value="주소 찾기">
					<div>
						<input type="text" name="address_detail" id="detailAddress"
							placeholder="상세 주소">
					</div>
				</div>
				<hr>
