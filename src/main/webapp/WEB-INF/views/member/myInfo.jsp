                    ...
                    fetch(url, {
                        ...
                        .then(res => {
                            if (res.status == '500') {
                                ...
                                Swal.fire("회원 탈퇴 완료되었습니다.", "메인화면으로 돌아갑니다.", "success");
                                setTimeout(() => { // after 0.9sec
                                    window.self.location = "${contextPath}/main.do";
                                }, 900);
                            }
                        })
                }
                    ...
                    <div class="tab-pane fade show active" id="nav-home"
                        ...
                        <form action="${contextPath}/member/modMyInfo.do" method="POST"
                            ...
                            <div id="modifyInfo" style="margin-bottom: 30px;">
                                ...
                                <input type="button" class="btn btn-outline-danger"
                                       value="탈퇴하기" onclick='handleWithdrawal()'>
                            </div>
                        </form>
                                    ...
                                    <c:choose>
                                        ...
                                        <c:when
                                            ...
                                            <td style="text-align: center;"><a
                                                    href="${pageContext.request.contextPath}/survey/surveyWriteForm.do?courseID=${myCourse.courseID}&userID=${myCourse.userID}">설문조사</a>
                                            </td>
                                        </c:when>
                                        <c:when
