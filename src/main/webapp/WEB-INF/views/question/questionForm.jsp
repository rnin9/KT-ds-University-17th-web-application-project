...
<body>
	...
	<div class="container">
		...
		<form role="form" method="post"
			action="${contextPath}/question/insertQuestion.do">
			<div class="mb-3 row">
			...
			<div class="mb-3 row" id="Title">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="questionTitle"
						name="questionTitle" placeholder="제목을 입력해주세요" required />
				</div>
			</div>

			<div class="mb-3 row" id="questionType">
				<label for="questionTitle" class="col-sm-2 col-form-label">질문
					분류</label>
				<div class="col-sm-10">
					<select class="form-select" id="select" id="questionType"
						name="questionType" aria-label="Default select example" required>
			...
			<div class="mb-3 row" id="questionContent">
				<label for="questionContent" class="col-sm-2 col-form-label">질문
					내용</label>
				<div class="col-sm-10">
					<textarea class="form-control" id="questionContent"
