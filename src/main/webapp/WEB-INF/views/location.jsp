...
.sub_visual {
	...
	background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)),
		url("${pageContext.request.contextPath}/resources/image/sub_visual/location.jpg");
	border: 0;
	font-size: 32px;
	font-weight: 500;
	height: 190px;
...
<body>
	...
	<div class="container">
		...
		<div class="mapContainer" style="background-color: white">
			...
			<div class="pageIntro">교육장 시설</div>


			<!-- 캐러셀 시작 -->
			<div
				style="width: 70%; height: 70%; margin-left: 15%; margin-top: 30px;"
			...
			<div
				style="display: flex; justify-content: center; margin-top: 100px; padding-bottom: 60px">
				<%--      교육센터 안내도 이미지      --%>
				<img
