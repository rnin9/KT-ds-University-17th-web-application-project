...
<title itemprop="name">403 Error Page</title>
					...
					<div class="middle">
						<div class="inner">
							<div class="inner-circle">
								<i class="fa fa-home"></i><span>401</span>
							</div>
							<span class="inner-status">인증이 필요합니다.</span> <span
								class="inner-detail" style="color: #000000;"> 접근 페이지에 적합한 인증이 필요합니다.
							<br>
							<br>
							<c:choose>
