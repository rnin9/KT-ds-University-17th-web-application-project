...
<title itemprop="name">Preview Bootstrap snippets. 500 error
	page with particles</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="description"
	content="Preview Bootstrap snippets. 500 error page with particles. Copy and paste the html, css and js code for save time, build your app faster and responsive">
<meta name="keywords"
...
<link rel="canonical"
	href="https://www.bootdey.com/snippets/preview/500-error-page-with-particles"
	itemprop="url">
<meta property="og:title"
	content="Preview Bootstrap  snippets. 500 error page with particles">
<meta property="og:url"
	content="https://www.bootdey.com/snippets/preview/500-error-page-with-particles">
<meta property="og:image"
	content="https://www.bootdey.com/files/SnippetsImages/bootstrap-snippets-624.png">
				...
				<div class="outer">
					<div class="middle">
						<div class="inner">
							...
							<span class="inner-status">일시적 오류가 발생했습니다</span> <span
								class="inner-detail" style="color: #fff;"> 서비스 이용에 불편을 드려 죄송합니다.
								<br>일시적인 현상이거나 네트워크 문제일 수 있으니 잠시 후 다시 시도해주세요.</span>
						</div>
					</div>
				</div>
			</div>
