...
public class MemberServiceImpl implements MemberService {
   ...
   public int join_member(MemberVO member, HttpServletResponse response) throws Exception {
      ...
      if (memberDAO.check_id(member.getUserId()) == 1) {      // 중복된 아이디
         ...
         out.println("Swal.fire({title:'회원가입을 축하드립니다!!',   text: '메일을 인증을 완료하세요!', icon:'success', backdrop: 'rgba(0,0,123,0.4) url(\"/ktu/resources/image/nyan.gif\") left top no-repeat'})");
